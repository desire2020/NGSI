...
import utils.psd_matrices as psd_matrices

#from profiler import profiled
import utils.profiler as profiler
profiled = profiler.profiled('gaussians')
from utils.misc import _err_string, process_slice, my_sum, match_shapes, dot, full_shape, broadcast, set_err_info, transp
